...
export default function Input(props: React.InputHTMLAttributes<HTMLInputElement> & { classes?: string, error?: string, tailText?: string }) {
    ...
    return <>
        <div className="relative">
            <input onWheel={(e)=>e.currentTarget.blur()} {...rest} className={clsx(error ? "border-red-500" : "", classes || '', "outline-none text-lg  p-4 rounded-md border border-gray-300 font-bold focus:border-black  w-full")} />
