...
export default function Home() {
    ...
    useEffect(() => {
        const browserLocale = path=="/" ? (navigator.language || navigator.languages[0] || "en") : "en";
        setUserLocale(browserLocale)
    }, [])
    return (<section className="max-w-3xl mx-auto min-h-screen py-10 px-3">
        <h1 className="whitespace-pre-line text-[44px] md:text-5xl !leading-normal font-bold text-black text-center">{t(`Mock interviews with an AI interviewer trained on 40,000 interview questions`)}</h1>
